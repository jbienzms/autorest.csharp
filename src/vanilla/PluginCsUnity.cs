...
{
    public sealed class PluginCsUnity :Plugin<GeneratorSettingsCs, TransformerCs, CodeGeneratorCsUnity, CodeNamerCs, CodeModelCs>
    {
        public PluginCsUnity()
        {
            Context = new Context
            {
                ...
                new Factory<PrimaryType, PrimaryTypeUnity>()
            };
        }
    }
}